...
function VicesIcon() {
  return (
    ...
    >
      <path d="M12 2.5C9.3 6.2 6 9.7 6 14.5a6 6 0 0 0 12 0c0-2.7-1.4-5.2-4-7.6.2 2-.5 3.4-1.5 4.5C13.3 8.8 12.4 5.8 12 2.5Z" />
      <path d="M12 12c-1.2 1.3-2.2 2.6-2.2 4.1a2.2 2.2 0 0 0 4.4 0c0-1.4-.9-2.8-2.2-4.1Z" />
    </svg>
  );
}
